...
FixedWingMission =  struct;
FixedWingMission(1).mode = 2;
FixedWingMission(1).position = [500; 0; -100];
FixedWingMission(1).params = [0; 0; 0; 70*const.kts2mps];
FixedWingMission(2).mode = 2;
FixedWingMission(2).position = [500; 1000; -100];
FixedWingMission(2).params = [0; 0; 0; 65*const.kts2mps];
FixedWingMission(3).mode = 2;
FixedWingMission(3).position = [-500; 1000; -100];
FixedWingMission(3).params = [0; 0; 0; 80*const.kts2mps];
FixedWingMission(4).mode = 2;
FixedWingMission(4).position = [-500; 0; -100];
FixedWingMission(4).params = [0; 0; 0; 65*const.kts2mps];
FixedWingMission(5).mode = 2;
FixedWingMission(5).position = [500; 0; -100];
FixedWingMission(5).params = [0; 0; 0; 70*const.kts2mps];
