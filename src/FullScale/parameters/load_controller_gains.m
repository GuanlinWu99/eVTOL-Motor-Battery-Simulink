...
% This function calls the PID controller gains for 1) Hover and 2) Fixed-Wing modes
...
% VTOLcontrolGains.I_ROLL_RATE    =   5.2450e+4;      
...
%% [2] Fixed Wing Default Control Gains

% Altitude
FWControlParams.P_CLIMBRATE     =   10*0.1; 
FWControlParams.P_ALT           =   0.3; 
FWControlParams.P_AIRSPD        =   360;
FWControlParams.I_AIRSPD        =   5;
FWControlParams.D_AIRSPD        =   120;
FWControlParams.N_AIRSPD        =   100;

% Roll 
FWControlParams.P_FW_ROLL       =   2*2;

% Pitch
FWControlParams.P_FW_PITCH      =   6;
FWControlParams.I_FW_PITCH      =   0;
FWControlParams.D_FW_PITCH      =   0;
FWControlParams.N_FW_PITCH      =   2.18933823147713;

% Roll Rate
FWControlParams.P_FW_ROLLRATE   =   0.4*3;
FWControlParams.I_FW_ROLLRATE   =   0.8*1;
