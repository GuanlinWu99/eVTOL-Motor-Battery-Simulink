...
function [alpha, CL, CD, CM] = eVTOL_data_alpha()
    csvFileName =   'Data_eVTOL_alpha.csv';
    ...
    alpha       =   alpha_ex(1:numberofpoints);
    CL          =   CL_ex(1:numberofpoints);
    CD          =   CD_ex(1:numberofpoints);
    CM          =   CMy_ex(1:numberofpoints);
end