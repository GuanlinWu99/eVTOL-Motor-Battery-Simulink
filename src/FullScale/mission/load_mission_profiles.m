...
switch Profile
    ...
    case {1, 2, 3}
        ...
        TransitionMission(10).params    =   [0; 0; 0; 0*const.kts2mps];
        ...
        TransitionMission(11).mode      =   4;                              % [-] landing
        TransitionMission(11).position  =   [(1.5+2.82+2.08+1.17+0.62)*const.nm2m; 0; 0*const.ft2m];
    ...
    case {4, 5, 9, 10}
        ...
        % [-] takeoff (VTOL waypoint for reaching hovering altitude)
        TransitionMission(2).mode       =   2;                              
        TransitionMission(2).position   =   [0; 0; -300*const.ft2m];
        TransitionMission(2).params     =   [0; 0; 0; 10*const.kts2mps];
    
        % [-] initial climb (forward transition before climb)
        TransitionMission(3).mode       =   6;                              
        TransitionMission(3).position   =   [0.62*const.nm2m-200; 0; -300*const.ft2m]; 
        TransitionMission(3).params     =   [1; 1; 1; 60*const.kts2mps];

        % [-] initial climb (altitude hold vertical autopilot)
        TransitionMission(4).mode       =   2;                              
        TransitionMission(4).position   =   [0.62*const.nm2m; 0; -500*const.ft2m]; 
        TransitionMission(4).params     =   [0; 0; 1; 75*const.kts2mps];

        % [-] second climb (flight path hold vertical autopilot)
    ...
    case {6, 7, 8}
        ...
        % [-] landing
        TransitionMission(11).mode      =   4;                              
        TransitionMission(11).position  =   [(1.5+5.34+12.01+3.53+0.62)*const.nm2m; 0; 0*const.ft2m];
        TransitionMission(11).params    =   [0; 0; 0; 0];
        
    %% .. Testing hover mode under crosswind ... (Multicopter mode)
    case 11
        TransitionMission               =   struct;
        ...
        TransitionMission(2).mode       =   2;                              
        TransitionMission(2).position   =   [0; 0; -200*const.ft2m];
        TransitionMission(2).params     =   [0; 0; 0; 10*const.kts2mps];

        TransitionMission(3).mode       =   2;                              
        TransitionMission(3).position   =   [50; 0; -200*const.ft2m]; 
        TransitionMission(3).params     =   [0; 0; 0; 10*const.kts2mps];

        TransitionMission(4).mode       =   2;                              
        TransitionMission(4).position   =   [100; 0; -200*const.ft2m]; 
        TransitionMission(4).params     =   [0; 0; 0; 0*const.kts2mps];

        TransitionMission(5).mode       =   2;                              
        TransitionMission(5).position   =   [200; 0; -200*const.ft2m]; 
        TransitionMission(5).params     =   [0; 0; 0; 0*const.kts2mps];

        TransitionMission(6).mode       =   4;                              
        TransitionMission(6).position   =   [200; 0; 0]; 
        TransitionMission(6).params     =   [0; 0; 0; 0];
    
        %% Original code by MH (long distance)
    case 12
        TransitionMission               =   struct;
        % [-] takeoff
        TransitionMission(1).mode       =   1;                              
