...
switch Profile
    ...
    case 1
        ...
        TransitionMission(8).mode       =   2;                              % [-] approach pattern (FW, slow cruise)
        TransitionMission(8).position   =   [(1.5+2.82+2.08+1.17+0.62)*const.nm2m-2000; 0; -300*const.ft2m];
        TransitionMission(8).params     =   [0; 0; 1; 70*const.kts2mps];
    
        TransitionMission(9).mode       =   6;                              % [-] approach pattern (back transition)
        TransitionMission(9).position   =   [(1.5+2.82+2.08+1.17+0.62)*const.nm2m-100; 1; -300*const.ft2m];
        TransitionMission(9).params     =   [1; 1; 1; 1];

        TransitionMission(10).mode      =   2;                              % [-] approach pattern (VTOL, reaching hovering point)
        TransitionMission(10).position  =   [(1.5+2.82+2.08+1.17+0.62)*const.nm2m; 1; -300*const.ft2m];
    ...
    case 6
        ...
        TransitionMission(8).mode       =   2;                              % [-] approach pattern (FW, slow cruise)
        TransitionMission(8).position   =   [(1.5+5.34+12.01+3.53+0.62)*const.nm2m-2000; 0; -300*const.ft2m];
        TransitionMission(8).params     =   [0; 0; 1; 70*const.kts2mps];
    
        TransitionMission(9).mode       =   6;                              % [-] approach pattern (back transition)
        TransitionMission(9).position   =   [(1.5+5.34+12.01+3.53+0.62)*const.nm2m-100; 1; -300*const.ft2m];
        TransitionMission(9).params     =   [1; 1; 1; 1];

        TransitionMission(10).mode      =   2;                              % [-] approach pattern (VTOL, reaching hovering point)
        TransitionMission(10).position  =   [(1.5+5.34+12.01+3.53+0.62)*const.nm2m; 1; -300*const.ft2m];
        TransitionMission(10).params    =   [1; 1; 1; 1];
