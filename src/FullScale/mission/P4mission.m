...
switch Mode
    ...
    case 2
        ...
        TransitionMission(8).position   = [6700+3000; 0; -500];
        TransitionMission(8).params     = [1; 1; 1; 1];

        % Hover
        TransitionMission(9).mode       = 2;
        TransitionMission(9).position   = [6700+3000; 0; -100];
        TransitionMission(9).params     = [0; 0; 0; 0];

        % Hover
        TransitionMission(10).mode      = 2;
        TransitionMission(10).position  = [6700+3000; 0; -30];
        TransitionMission(10).params    = [0; 0; 0; 0];

        % Vertical landing
        TransitionMission(11).mode      = 4;
        TransitionMission(11).position  = [6700+3000; 0; 0];
        TransitionMission(11).params    = [0; 0; 0; 0];
