...
TransitionMission(2).position = [0; 0; -100*const.ft2m];
...
TransitionMission(5).params = [0; 0; 0; 82*const.kts2mps];
...
TransitionMission(8).position = [(3.76+0.62+1.2+2.61+1.5)*const.nm2m-2200; 0; -900*const.ft2m];
TransitionMission(8).params = [0; 0; 0; 62*const.kts2mps];
TransitionMission(9).mode = 6;
TransitionMission(9).position = [1; 1; 1];
