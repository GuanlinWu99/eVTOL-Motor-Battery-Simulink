...
TransitionMission(2).params   = [0; 0; 0; 0];
TransitionMission(3).mode     = 6;
TransitionMission(3).position = [0.62*const.nm2m-300; 0; -500*const.ft2m]; % 1000 정도 되야 lateral error 나쁘지 않음 
TransitionMission(3).params   = [1; 1; 1; 1];
TransitionMission(4).mode     = 2;
TransitionMission(4).position = [0.62*const.nm2m; 0; -500*const.ft2m];
TransitionMission(4).params   = [0; 0; 1; 75*const.kts2mps];
TransitionMission(5).mode     = 2;
TransitionMission(5).position = [(3.76+0.62)*const.nm2m; 0; -1800*const.ft2m];
TransitionMission(5).params   = [0; 0; 2; 75*const.kts2mps];
TransitionMission(6).mode     = 2;
TransitionMission(6).position = [(3.76+0.62+1.2)*const.nm2m; 0; -1800*const.ft2m];
...
TransitionMission(8).mode     = 2;
TransitionMission(8).position = [(3.76+0.62+1.2+2.61+1.5)*const.nm2m-2250; 0; -500*const.ft2m];
TransitionMission(8).params   = [0; 0; 1; 75*const.kts2mps];

TransitionMission(9).mode = 6;
TransitionMission(9).position = [(3.76+0.62+1.2+2.61+1.5)*const.nm2m-100; 1; 1];
TransitionMission(9).params = [1; 1; 1; 1];

TransitionMission(10).mode = 2;
TransitionMission(10).position = [(3.76+0.62+1.2+2.61+1.5)*const.nm2m; 0; -500*const.ft2m];
TransitionMission(10).params = [0; 0; 0; 0];
