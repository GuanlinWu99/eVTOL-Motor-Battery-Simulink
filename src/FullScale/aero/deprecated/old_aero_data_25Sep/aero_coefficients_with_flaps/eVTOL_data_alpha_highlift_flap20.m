...
function [alpha_h_20, CL_h_20, CD_h_20, CM_h_20] = eVTOL_data_alpha_highlift_flap20()
    csvFileName =   'Data_eVTOL_alpha_highlift_flap20.csv';
    ...
    alpha_h_20       =   alpha_ex(1:numberofpoints);
    CL_h_20          =   CL_ex(1:numberofpoints);
    CD_h_20          =   CD_ex(1:numberofpoints);
    CM_h_20          =   CMy_ex(1:numberofpoints);
end