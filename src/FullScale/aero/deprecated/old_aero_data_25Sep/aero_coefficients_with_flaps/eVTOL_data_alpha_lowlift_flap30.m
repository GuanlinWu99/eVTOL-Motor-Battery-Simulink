...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [alpha_l_30, CL_l_30, CD_l_30, CM_l_30] = eVTOL_data_alpha_lowlift_flap30()
    ...
    CL_l_30          =   CL_ex(1:numberofpoints);
    CD_l_30          =   CD_ex(1:numberofpoints);
    CM_l_30          =   CMy_ex(1:numberofpoints);
end