...
function [alpha_h_0, CL_h_0, CD_h_0, CM_h_0] = eVTOL_data_alpha_highlift_flap0()
    csvFileName =   'Data_eVTOL_alpha_highlift_flap0.csv';
    ...
    alpha_h_0       =   alpha_ex(1:numberofpoints);
    CL_h_0          =   CL_ex(1:numberofpoints);
    CD_h_0          =   CD_ex(1:numberofpoints);
    CM_h_0          =   CMy_ex(1:numberofpoints);
end