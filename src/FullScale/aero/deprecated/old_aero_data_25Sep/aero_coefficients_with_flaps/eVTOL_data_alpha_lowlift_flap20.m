...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [alpha_l_20, CL_l_20, CD_l_20, CM_l_20] = eVTOL_data_alpha_lowlift_flap20()
    ...
    CL_l_20          =   CL_ex(1:numberofpoints);
    CD_l_20          =   CD_ex(1:numberofpoints);
    CM_l_20          =   CMy_ex(1:numberofpoints);
end