...
function [alpha_20, CL_20, CD_20, CM_20] = Data_eVTOL_alpha_flap20()
    csvFileName =   'Data_eVTOL_alpha_flap20.csv';
    ...
    alpha_20       =   alpha_ex(1:numberofpoints);
    CL_20          =   CL_ex(1:numberofpoints);
    CD_20          =   CD_ex(1:numberofpoints);
    CM_20          =   CMy_ex(1:numberofpoints);
end