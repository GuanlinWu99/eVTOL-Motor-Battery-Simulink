...
function [alpha_0, CL_0, CD_0, CM_0] = Data_eVTOL_alpha_flap0()
    csvFileName =   'Data_eVTOL_alpha_flap0.csv';
    ...
    alpha_0       =   alpha_ex(1:numberofpoints);
    CL_0          =   CL_ex(1:numberofpoints);
    CD_0          =   CD_ex(1:numberofpoints);
    CM_0          =   CMy_ex(1:numberofpoints);
end