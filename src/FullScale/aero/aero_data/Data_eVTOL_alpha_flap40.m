...
function [alpha_40, CL_40, CD_40, CM_40] = Data_eVTOL_alpha_flap40()
    csvFileName =   'Data_eVTOL_alpha_flap40.csv';
    ...
    alpha_40       =   alpha_ex(1:numberofpoints);
    CL_40          =   CL_ex(1:numberofpoints);
    CD_40          =   CD_ex(1:numberofpoints);
    CM_40          =   CMy_ex(1:numberofpoints);
end