...
function [alpha_30, CL_30, CD_30, CM_30] = Data_eVTOL_alpha_flap30()
    csvFileName =   'Data_eVTOL_alpha_flap30.csv';
    ...
    alpha_30       =   alpha_ex(1:numberofpoints);
    CL_30          =   CL_ex(1:numberofpoints);
    CD_30          =   CD_ex(1:numberofpoints);
    CM_30          =   CMy_ex(1:numberofpoints);
end