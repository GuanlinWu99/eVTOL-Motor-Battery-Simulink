...
function [alpha_10, CL_10, CD_10, CM_10] = Data_eVTOL_alpha_flap10()
    csvFileName =   'Data_eVTOL_alpha_flap10.csv';
    ...
    alpha_10       =   alpha_ex(1:numberofpoints);
    CL_10          =   CL_ex(1:numberofpoints);
    CD_10          =   CD_ex(1:numberofpoints);
    CM_10          =   CMy_ex(1:numberofpoints);
end