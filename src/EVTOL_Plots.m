function EVTOL_Plots(simOut)
    ...
    Omega1                =  simOut.Rotor1_omega.Data;
    Omega2                =  simOut.Rotor2_omega.Data;
    Omega3                =  simOut.Rotor3_omega.Data;
    Omega4                =  simOut.Rotor4_omega.Data;
    ...
    plot3(positionFeedbackData(4,:),positionFeedbackData(5,:),-positionFeedbackData(6,:),'LineWidth',3); grid on
    xlabel('North [m]')
    ylabel('West [m]')
    zlabel('Altitude [m]')
    zlim([-1 100]);
    ...
    %hold on;
    plot(simOut.PositionCmdFdbk.time,positionFeedbackData(4,:),'LineWidth',2)
    hold on;
    grid on
    xlim([0 simTime]);
    ylabel('North (m)')
    ...
    hold on;
    plot(simOut.PositionCmdFdbk.time,positionFeedbackData(5,:),'LineWidth',2)
    xlim([0 simTime]);
    grid on
    ylabel('West (m)')
    ...
    %hold on;
    plot(simOut.PositionCmdFdbk.time,-positionFeedbackData(6,:),'LineWidth',2)
    grid on
    xlim([0 simTime]);
    xlabel('Time [s]')
    ylabel('Altitude [m]')
