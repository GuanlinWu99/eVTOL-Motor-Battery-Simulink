...
HEV_Param.Battery_Cell.Rated_Capacity     = 5;                       % Ampere-hours (battery cell rate capacity)
HEV_Param.Battery_Cell.SOC_init           = 0.9;                     % Initial SOC value
...
HEV_Param.Motor.Efficiency                   = 91;          % motor efficiency
