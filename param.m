...
HEV_Param.Battery_Sys.Rated_Capacity = 5;     % Ampere-hours
HEV_Param.Battery_Sys.Initial_Charge = 5;    % Ampere-hours
...
HEV_Param.Battery_Cell.Emo = 96/4; % (V) [max o.c. volts per cell]
...
HEV_Param.Motor.TorqSpdLUT.TorqueNm = [10     10     10     10     10      10     8     2];
HEV_Param.Motor.NominalSpeedRPM = 3000;
HEV_Param.Motor.NominalTorqueNm = 30;

HEV_Param.Motor.Damping = 8e-3; %N*m/(rad/s)
HEV_Param.Motor.TorqueControl_TimeConst = 0.001; %0.02*1/1.5;
...
% 
%% Testing
t_orig = [0 1   3   9   10  12  14  15  16  18  19  20 50 80  90  110 140 200 250 280 380 382  383 400 500]';
u_orig = [0 45  28  26  3   25  28  18  28  48  3   15 20 26  27  28  2   2   13  2   50  30   45  30  0]';

% t_orig = [0 10  20  110 140 200 250 280]';
% u_orig = [0 30  100 60  120 120 30  30 ]';
